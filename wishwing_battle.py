...
class stats(Cog):
    ...
    async def stat_input(self, ctx):
        ...
        waiting_wishwing_1 = Embed(title = "Waiting for stats for Wishwing 1...")
        ...
        """WishWing2!!!"""
        waiting_wishwing_2 = Embed(title = "Waiting for stats for Wishwing 2...")
...
{wishwing2.name} HEALTH 0""")
            ...
            if wishwing2.type == wishwing1.type:
                ...
                wishwing1.hp -= (wishwing2.attack * 0.5 + wishwing2.magic * 0.5 - (wishwing1.defense * .2))
